...
async function main() {
    ...
    const trips = await Promise.all([
        ...
        prisma.trip.create({ data: { code: 'T007', vehicleId: vehicles[8].id, driverId: drivers[3].id, origin: 'Jaipur', destination: 'Udaipur', cargoDescription: 'Furniture - 40 pieces', cargoWeightKg: 7000, status: 'ON_TRIP', startOdometerKm: 27000, dispatchedAt: new Date('2026-02-20T06:00:00Z'), revenue: 42000 } }),
        prisma.trip.create({ data: { code: 'T008', vehicleId: vehicles[9].id, driverId: drivers[0].id, origin: 'Madurai', destination: 'Trichy', cargoDescription: 'Food packages - 200 boxes', cargoWeightKg: 600, status: 'ON_TRIP', startOdometerKm: 9000, dispatchedAt: new Date('2026-02-20T08:00:00Z'), revenue: 10000 } }),
        // Draft trips (pending)
